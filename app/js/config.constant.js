...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** Controllers
        'dashboardCtrl': '/js/controllers/old/dashboardCtrl.js',
        'iconsCtrl': '/js/controllers/old/iconsCtrl.js',
        'vAccordionCtrl': '/js/controllers/old/vAccordionCtrl.js',
        'ckeditorCtrl': '/js/controllers/old/ckeditorCtrl.js',
        'laddaCtrl': '/js/controllers/old/laddaCtrl.js',
        'ngTableCtrl': '/js/controllers/old/ngTableCtrl.js',
        'cropCtrl': '/js/controllers/old/cropCtrl.js',
        'asideCtrl': '/js/controllers/old/asideCtrl.js',
        'toasterCtrl': '/js/controllers/old/toasterCtrl.js',
        'sweetAlertCtrl': '/js/controllers/old/sweetAlertCtrl.js',
        'mapsCtrl': '/js/controllers/old/mapsCtrl.js',
        'chartsCtrl': '/js/controllers/old/chartsCtrl.js',
        'calendarCtrl': '/js/controllers/old/calendarCtrl.js',
        'nestableCtrl': '/js/controllers/old/nestableCtrl.js',
        'validationCtrl': ['/js/controllers/old/validationCtrl.js'],
        'userCtrl': ['/js/controllers/old/userCtrl.js'],
        'selectCtrl': '/js/controllers/old/selectCtrl.js',
        'wizardCtrl': '/js/controllers/old/wizardCtrl.js',
        'uploadCtrl': '/js/controllers/old/uploadCtrl.js',
        'treeCtrl': '/js/controllers/old/treeCtrl.js',
        'inboxCtrl': '/js/controllers/old/inboxCtrl.js',
        'xeditableCtrl': '/js/controllers/old/xeditableCtrl.js',
        'chatCtrl': '/js/controllers/old/chatCtrl.js',
        'dynamicTableCtrl': '/js/controllers/old/dynamicTableCtrl.js',
        'notificationIconsCtrl': '/js/controllers/old/notificationIconsCtrl.js',
        'dateRangeCtrl': '/js/controllers/old/daterangeCtrl.js',
        'notifyCtrl': '/js/controllers/old/notifyCtrl.js',
        'sliderCtrl': '/js/controllers/old/sliderCtrl.js',
        'knobCtrl': '/js/controllers/old/knobCtrl.js',
    },
    //*** angularJS Modules
    modules: [{
        name: 'toaster',
